...
setwd('C:/Users/trela/Python Programming/ICE1 Turn In/01. Dataset Creation')
...
path <- 'C:/Users/trela/Python Programming/ICE1 Turn In/00. Raw Data/bbc'
...
df_final <-
  df_final %>% mutate(Complete_Filename = paste(File_Name, Category, sep='-'))
